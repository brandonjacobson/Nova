...
const RegisterNovaLetters = () => {
  ...
  return (
    <svg
      ref={svgRef}
      className="register-logo-svg"
      viewBox="0 0 600 200"
      preserveAspectRatio="xMidYMid meet"
      onMouseLeave={handleMouseLeave}
    >
      <defs>
        <linearGradient id="silverGradientRegister" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <filter id="textGlowRegister" x="-20%" y="-20%" width="140%" height="140%">
      ...
      {['N', 'O', 'V', 'A'].map((char, index) => {
        ...
        return (
          ...
          >
            <motion.text
              className="register-curved-text register-letter"
              fill="url(#silverGradientRegister)"
              filter="url(#textGlowRegister)"
    ...
    <div className="register-page" ref={containerRef}>
      <div className="register-container">
        ...
        >
          ...
          >
            <motion.div
              className="register-horizon-glow"
              style={{ opacity: glowOpacity }}
            />
            <svg
              className="register-horizon-svg"
              viewBox="0 0 1440 200"
              preserveAspectRatio="none"
            >
              <defs>
                <linearGradient id="registerHorizonGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <filter id="registerHorizonGlow" x="-20%" y="-100%" width="140%" height="300%">
              ...
              <path
                ...
                fill="none"
                stroke="url(#registerHorizonGradient)"
                strokeWidth="2"
                filter="url(#registerHorizonGlow)"
              />
              <path
